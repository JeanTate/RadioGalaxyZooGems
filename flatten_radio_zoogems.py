...
sorted_location = location.partition('-class')[0] + '_sorted.csv'
aggregate_location = location.partition('-class')[0] + '_aggregated.csv'
sorted_aggregate = location.partition('-class')[0] + '_ranked.csv'
...
def include(class_record):
    ...
    if class_record['user_name'] == 'JeanTate':
        return False
    if '2018-02-18 11:00:00 UTC' >= class_record['created_at'] >= '2018-02-02 22:00:00 UTC':
